...
public class SystemViewController implements Initializable {
    ...
    private void setTextSprite(SpriteData.Sprite newSprite) {
        switch (textSpriteIndex) {
            case 0 -> {
                appState.getCardData().getCardSprites().setReady(newSprite);
            }
            case 1 -> {
                appState.getCardData().getCardSprites().setGo(newSprite);
            }
            case 2 -> {
                appState.getCardData().getCardSprites().setWin(newSprite);
            }
            case 3 -> {
                appState.getCardData().getCardSprites().setLose(newSprite);
            }
        }
    }
